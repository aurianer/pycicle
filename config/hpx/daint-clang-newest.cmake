...
set(CFLAGS              "")
set(CXXFLAGS            "-Wno-unused-command-line-argument -stdlib=libc++ -nostdinc++ -I${CLANG_ROOT}/include/c++/v1 -L${CLANG_ROOT}/lib -Wl,-rpath,${CLANG_ROOT}/lib")
set(LDFLAGS             "")
set(LDCXXFLAGS          "${LDFLAGS} -stdlib=libc++ -L${CLANG_ROOT}/lib -Wl,-rpath,${CLANG_ROOT}/lib")

set(PYCICLE_BUILD_STAMP "clang-newest")
...
string(CONCAT CTEST_BUILD_OPTIONS ${CTEST_BUILD_OPTIONS}
    ...
    #"  -DHPX_WITH_APEX=ON " # TODO: Some tests time out with APEX on.
